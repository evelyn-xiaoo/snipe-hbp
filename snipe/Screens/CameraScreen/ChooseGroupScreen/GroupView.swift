...
class UploadView: UIView {
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            placeholders[0].leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 10),
            ...
            placeholders[2].trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -10),
